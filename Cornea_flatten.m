function [delta_matrix, smooth_surf, smooth_poly, Path_save_flat, Path_save_crelation, numframes, original_stack, flip, cmap, Cl] = Cornea_flatten(thres_hold, flip)
...
original_stack = zeros(size_of_frame(1), size_of_crop(2), numframes);
